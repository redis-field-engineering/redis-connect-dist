...
<table cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td> <b>SAVE Job Configuration</b> <br> Navigate to QUICK START and SAVE a Job configuration payload using the upload method. See sample job configuration payloads for <a href="/examples/postgres/demo/config/samples/payloads/postgres-job.json">PostgreSQL</a>, <a href="/examples/postgres/demo/config/samples/payloads/oracle-job.json">Oracle</a>, <a href="/examples/postgres/demo/config/samples/payloads/mssql-job.json">SQL Server</a>, <a href="/examples/postgres/demo/config/samples/payloads/mysql-job.json">MySQL</a> and <a href="/examples/postgres/demo/config/samples/payloads/db2-job.json">DB2</a>.
        </td>
